...
// long input options
$lopt = ['outpath:', 'type:', 'encoding:', 'flags:', 'platform_id:', 'encoding_id:', 'linked', 'fonts:', 'help'];
...
foreach ($options['fonts'] as $font) {
    try {
        ...
        $fileHelper = new File(allowedPaths: $allowedPaths);
        ...
        $convert_errors++;
        \fwrite(STDERR, "\033[31m--- ERROR: can not add $font\n           " . $exc->getMessage() . "\033[m\n");
    }
}
